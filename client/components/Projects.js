        ...
        <Card className="work-card">
          ...
          <Card.Body className="justify-content-center">
            ...
            <Card.Text>
              ...
              {' '}
              <a href="https://github.com/earthlymeg/proxy-2/" target="_blank">[ GitHub ]</a>
      ...
      <Col className="align-item-center projCol second">
        <Card className="work-card">
          ...
          <Card.Body className="justify-content-center">
            ...
            <Card.Text>
              JavaScript / PostgreSQL / New Relic / k6 / Docker
              {' '}
              <a href="https://github.com/Teddi-s-Angels/meg-sdc" target="_blank">[ GitHub ]</a>
            </Card.Text>
          </Card.Body>
        </Card>
      </Col>
